  ...
  return (
    ...
    >
      ...
      <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        {/* Scroll Indicator (disabled for initial publish) */}
        {!INITIAL_PUBLISH && (
          ...
          <section id="about" className="py-32 px-6 lg:px-12">
            <div className="max-w-7xl mx-auto w-full">
              <div className="grid lg:grid-cols-2 gap-20 items-center">
                <div className={`transition-all duration-1000 ${visibleSections.about ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`}>
                ...
                <div className={`relative transition-all duration-1000 delay-300 ${visibleSections.about ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-20'}`}>
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 lg:gap-6">
                {services.map((service, index) => (
                  <div
                    ...
                    className={`relative aspect-[50/49] rounded-2xl border ${darkMode ? 'border-white/10' : 'border-gray-900/10'} overflow-hidden cursor-pointer group transition-all duration-700 ${
                            ...
                            {project.image && (
                              <div className="mb-8 lg:mb-12">
                                <div className="relative aspect-[21/9] rounded-2xl overflow-hidden border border-white/10 group/img">
                                  ...
                                  />
                                  <div className="absolute inset-0 opacity-40" style={{ background: `linear-gradient(to bottom, transparent 50%, ${project.color}40)` }} />
                                </div>
                              </div>
                            )}
